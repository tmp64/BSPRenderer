...
void DevConsoleDialog::ExecCommand(const char *command_line) {
    m_pConSystem->print(appfw::console::ConsoleMsgInfo(appfw::console::ConsoleMsgType::ConInput),
...
void DevConsoleDialog::onAdd(appfw::console::ConsoleSystem &conSystem) {
