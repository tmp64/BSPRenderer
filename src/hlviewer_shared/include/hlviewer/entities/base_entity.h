...
public:
    ...
    void initialize(int entIdx, WorldStateBase *worldState, std::string_view className, bsp::EntityKeyValues *kv);
    ...
    inline WorldStateBase *getWorldState() { return m_pWorldState; }
